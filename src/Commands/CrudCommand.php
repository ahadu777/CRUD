...
class CrudCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'This command makes a basic crud';
    ...
    public function handle()
    {
       ...
       <input class='btn btn-primary float-end' type='submit' value='submit'/>
        ...
        $this->info($name . " model, route, controller , migration and blade page created successfully");
    }
}
